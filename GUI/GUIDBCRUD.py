...
photo=PhotoImage(file='Ax1.png')

label1=Label(root,text="RollNo",width=50,height=2,bg="pink").grid(row=0,column=1)
label2=Label(root,text="First_Name",width=50,height=2,bg="pink").grid(row=1,column=1)
label3=Label(root,text="Last_Name",width=50,height=2,bg="pink").grid(row=2,column=1)
label4=Label(root,text="Phone_Number",width=50,height=2,bg="pink").grid(row=3,column=1)
label5=Label(root,text="City",width=50,height=2,bg="pink").grid(row=4,column=1)
label6=Label(root,text="State",width=50,height=2,bg="pink").grid(row=5,column=1)
label7=Label(root,text="Age",width=50,height=2,bg="pink").grid(row=6,column=1)
label12=Label(root,image=photo).grid(row=8,column=1)
...
def Clear():
    ...
    e6.delete(0, END)
    e7.delete(0, END)
button1=Button(root,text="Register",width=10,height=2,command=Register).grid(row=7,column=1)
button2=Button(root,text="Delete",width=10,height=2,command=Delete).grid(row=7,column=2)
button3=Button(root,text="Update",width=10,height=2,command=Update).grid(row=7,column=3)
button4=Button(root,text="Show record",width=10,height=2,command=ShowRecord).grid(row=7,column=4)
button5=Button(root,text="Show All",width=10,height=2,command=Showall).grid(row=7,column=5)
button6=Button(root,text="Clear",width=10,height=2,command=Clear).grid(row=7,column=6)
root.mainloop()